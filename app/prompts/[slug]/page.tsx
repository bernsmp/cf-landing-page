...
export default function PromptDetailPage() {
  ...
  const relatedPrompts = getRelatedPrompts(slug, 3);
      ...
      <main className="pt-32 pb-20 px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <aside className="hidden lg:block w-64 flex-shrink-0">
              <div className="sticky top-32 space-y-6">
                ...
                {/* Related Article - hidden until real articles exist */}
          ...
          <div className="lg:hidden mt-8 pt-8 border-t border-[var(--grey-800)]">
            ...
            {/* Mobile: Related Article - hidden until real articles exist */}
            {/* {prompt.relatedArticle && !isLocked && (
              <a
                href={prompt.relatedArticle.url}
                target="_blank"
                rel="noopener noreferrer"
                className="block mt-6 p-4 rounded-xl bg-[var(--grey-850)] border border-[var(--grey-800)] hover:border-[var(--brand-gold)]/50 transition-colors"
              >
                <span className="text-xs text-[var(--grey-500)] uppercase tracking-wider">Deep Dive</span>
                <p className="text-[var(--brand-gold)] mt-1">{prompt.relatedArticle.title} →</p>
              </a>
            )} */}
          </div>
        </div>
